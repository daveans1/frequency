...
##──────────────────────────────────────────────────────────────────────────────
-keepclassmembers class com.david.frequency.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}
-keep class com.david.frequency.utils.potoken.** { *; }
...
##──────────────────────────────────────────────────────────────────────────────
-keep class com.david.frequency.models.PersistQueue { *; }
-keep class com.david.frequency.models.PersistPlayerState { *; }
-keep class com.david.frequency.models.QueueData { *; }
-keep class com.david.frequency.models.QueueType { *; }
-keep class com.david.frequency.playback.queues.** { *; }
...
## 12. Google Cast
##──────────────────────────────────────────────────────────────────────────────
-keep class com.david.frequency.cast.** { *; }
...
##──────────────────────────────────────────────────────────────────────────────
-keep class com.david.frequency.recognition.VibraSignature { *; }
-keepclassmembers class com.david.frequency.recognition.VibraSignature {
    native <methods>;
}
...
## 16. Listen Together
##──────────────────────────────────────────────────────────────────────────────
-keep class com.david.frequency.listentogether.** { *; }
-keepclassmembers class com.david.frequency.listentogether.** { *; }
-keepclassmembers class com.david.frequency.listentogether.** {
    *** Companion;
}
-keepclasseswithmembers class com.david.frequency.listentogether.** {
    kotlinx.serialization.KSerializer serializer(...);
}
