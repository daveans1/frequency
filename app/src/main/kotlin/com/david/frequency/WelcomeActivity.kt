...
import com.david.frequency.constants.IsFirstRunKey
import com.david.frequency.ui.theme.vivimusicTheme
import com.david.frequency.ui.utils.safeOpenUri
...
class WelcomeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            com.david.frequency.utils.setAppLocale(this, locale)
        }
...
val GoogleSansFlex = FontFamily(
    Font(
        resId = com.david.frequency.R.font.google_sans_flex,
...
fun WelcomePagerScreen(onFinished: () -> Unit) {
    ...
    val customWelcomeFontFamily = FontFamily(
        Font(
            resId = com.david.frequency.R.font.sans_flex,
            variationSettings = FontVariation.Settings(
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.david.frequency.R.string.perm_required),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.david.frequency.R.string.perm_permissions),
                        fontFamily = GoogleSansFlex,
                        fontWeight = FontWeight.Bold,
                        fontSize = 48.sp,
                    ...
                    Text(
                        text = stringResource(com.david.frequency.R.string.perm_intro_text),
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            title = stringResource(com.david.frequency.R.string.perm_notif_title),
                            description = stringResource(com.david.frequency.R.string.perm_notif_desc),
                        ...
                        if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                            ...
                            PermissionCard(
                                ...
                                title = stringResource(com.david.frequency.R.string.perm_install_title),
                                description = stringResource(com.david.frequency.R.string.perm_install_desc),
            ...
            content = { onUpdateScroll ->
                Column(
                    ...
                    Column(modifier = Modifier.padding(bottom = 16.dp)) {
                        Text(
                            text = stringResource(com.david.frequency.R.string.feat_discover),
                            style = thinHeaderStyle,
                            color = MaterialTheme.colorScheme.onBackground
                        )
                        Text(
                            text = stringResource(com.david.frequency.R.string.feat_features),
                            fontFamily = GoogleSansFlex,
                            fontWeight = FontWeight.Bold,
                            fontSize = 48.sp,
                            color = MaterialTheme.colorScheme.primary,
                        ...
                        Text(
                            text = stringResource(com.david.frequency.R.string.feat_intro),
                            style = MaterialTheme.typography.bodyLarge.copy(
                                fontFamily = GoogleSansFlex
                            ),
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Box(modifier = Modifier.weight(1f)) {
                        ...
                        Column(
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffaee4),
                                iconTint = Color(0xFF8d0053),
                                title = stringResource(com.david.frequency.R.string.feat_lyrics_title),
                                description = stringResource(com.david.frequency.R.string.feat_lyrics_desc),
                                shape = topCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.david.frequency.R.string.feat_download_title),
                                description = stringResource(com.david.frequency.R.string.feat_download_desc)
                            )
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffb683),
                                iconTint = Color(0xFF753403),
                                title = stringResource(com.david.frequency.R.string.feat_quality_title),
                                description = stringResource(com.david.frequency.R.string.feat_quality_desc),
                                shape = middleCardShape
                            )
                            ...
                            if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                                ...
                                FeatureCard(
                                    ...
                                    title = stringResource(com.david.frequency.R.string.feat_update_title),
                                    description = stringResource(com.david.frequency.R.string.feat_update_desc),
                                    shape = middleCardShape
                                )
                            }
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.david.frequency.R.string.feat_license_title),
                                description = stringResource(com.david.frequency.R.string.feat_license_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.david.frequency.R.string.feat_github_title),
                                description = stringResource(com.david.frequency.R.string.feat_github_desc),
                                shape = bottomCardShape
                            )
            ...
            onSelect = { selectedLang ->
                scope.launch {
                    ...
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
                        ...
                        com.david.frequency.utils.setAppLocale(context, locale)
                        (context as? Activity)?.recreate()
                    }
                }
                showAppLanguageDialog = false
            },
            title = stringResource(com.david.frequency.R.string.app_language),
            current = appLanguage,
            values = (listOf(SYSTEM_DEFAULT) + LanguageCodeToName.keys.toList()),
            valueText = {
                LanguageCodeToName.getOrElse(it) { stringResource(com.david.frequency.R.string.system_default) }
            }
        )
    }
            ...
            Column(
                ...
                Row(
                    ...
                    FilledTonalIconButton(
                        ...
                        Icon(
                            painter = painterResource(id = com.david.frequency.R.drawable.language),
                    ...
                    WelcomeExpressiveButton(
                        text = if (isLastPage) stringResource(com.david.frequency.R.string.get_started) else stringResource(com.david.frequency.R.string.next),
                        onClick = {
                            if (isLastPage) {
            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = {
                        ...
                        Icon(
                            painter = painterResource(com.david.frequency.R.drawable.arrow_back),
                            contentDescription = stringResource(com.david.frequency.R.string.back_button_desc)
                        )
                    }
                },
