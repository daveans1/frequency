...
import com.david.frequency.constants.ListenTogetherAutoApprovalKey
import com.david.frequency.constants.ListenTogetherIsHostKey
import com.david.frequency.constants.ListenTogetherRoomCodeKey
import com.david.frequency.constants.ListenTogetherServerUrlKey
import com.david.frequency.constants.ListenTogetherSessionTimestampKey
import com.david.frequency.constants.ListenTogetherSessionTokenKey
import com.david.frequency.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.david.frequency.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.david.frequency.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.david.frequency.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.david.frequency.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.david.frequency.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.david.frequency.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
