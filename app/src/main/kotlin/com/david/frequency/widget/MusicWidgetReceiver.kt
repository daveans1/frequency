...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.david.frequency.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.david.frequency.widget.LIKE"
        const val ACTION_NEXT = "com.david.frequency.widget.NEXT"
        const val ACTION_PREVIOUS = "com.david.frequency.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.david.frequency.widget.UPDATE_WIDGET"
    }
}
