package com.david.frequency.ui.screens.wrapped.pages
...
import com.david.frequency.ui.screens.wrapped.LocalWrappedManager
import com.david.frequency.ui.screens.wrapped.PlaylistCreationState
import com.david.frequency.ui.screens.wrapped.WrappedConstants
import com.david.frequency.ui.screens.wrapped.components.AnimatedBackground
import com.david.frequency.ui.screens.wrapped.components.AutoResizingText
import com.david.frequency.ui.screens.wrapped.components.ShapeType
import com.david.frequency.ui.theme.bbh_bartle
...
fun PlaylistPage() {
    ...
    val (playlistImageRes, playlistImageName) = remember {
        if (Random.nextBoolean()) {
            Pair(R.drawable.frequencywrapped_v1, "frequencywrapped_v1")
        } else {
            Pair(R.drawable.frequencywrapped_v2, "frequencywrapped_v2")
        }
    }
