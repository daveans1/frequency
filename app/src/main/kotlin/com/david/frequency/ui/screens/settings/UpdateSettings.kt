...
import com.david.frequency.vivimusic.component.UpdateInfoDialog
import com.david.frequency.ui.utils.backToMain
import com.david.frequency.vivimusic.updater.getAutoUpdateCheckSetting
import com.david.frequency.vivimusic.updater.saveAutoUpdateCheckSetting
...
import com.david.frequency.vivimusic.updater.getDownloadedApkCount
import com.david.frequency.vivimusic.updater.clearDownloadedApks
import com.david.frequency.vivimusic.updater.getBetaUpdatesSetting
import com.david.frequency.vivimusic.updater.saveBetaUpdatesSetting
import com.david.frequency.vivimusic.updater.autoClearOldApks
            ...
            items = listOf(
                Material3SettingsItem(
                    ...
                    onClick = {
                        ...
                        if (isFoss) {
                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse(com.david.frequency.constants.GithubConfig.LATEST_RELEASE_URL))
