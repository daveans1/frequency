...
package com.david.frequency.db
...
import com.david.frequency.constants.AlbumSortType
import com.david.frequency.constants.ArtistSongSortType
import com.david.frequency.constants.ArtistSortType
import com.david.frequency.constants.PlaylistSortType
import com.david.frequency.constants.SongSortType
import com.david.frequency.db.entities.Album
import com.david.frequency.db.entities.AlbumArtistMap
import com.david.frequency.db.entities.AlbumEntity
import com.david.frequency.db.entities.AlbumWithSongs
...
import com.david.frequency.db.entities.EventWithSong
import com.david.frequency.db.entities.FormatEntity
import com.david.frequency.db.entities.LyricsEntity
import com.david.frequency.db.entities.PlayCountEntity
...
import com.david.frequency.db.entities.RecognitionHistory
import com.david.frequency.db.entities.RelatedSongMap
import com.david.frequency.db.entities.SearchHistory
import com.david.frequency.db.entities.SetVideoIdEntity
import com.david.frequency.db.entities.Song
import com.david.frequency.db.entities.SongAlbumMap
import com.david.frequency.db.entities.SongArtistMap
import com.david.frequency.db.entities.SongEntity
import com.david.frequency.db.entities.SongWithStats
import com.david.frequency.extensions.reversed
import com.david.frequency.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    fun artists(sortType: ArtistSortType, descending: Boolean, sourceFilter: com.david.frequency.constants.ArtistSourceFilter = com.david.frequency.constants.ArtistSourceFilter.ALL) =
        when (sortType) {
            ...
            artists
                .filter {
                    when (sourceFilter) {
                        com.david.frequency.constants.ArtistSourceFilter.ALL -> it.artist.isYouTubeArtist || it.artist.isLocal
                        com.david.frequency.constants.ArtistSourceFilter.LOCAL -> it.artist.isLocal
                        com.david.frequency.constants.ArtistSourceFilter.YOUTUBE -> it.artist.isYouTubeArtist
                    }
                }
                .reversed(descending)
        }

    fun artistsBookmarked(sortType: ArtistSortType, descending: Boolean, sourceFilter: com.david.frequency.constants.ArtistSourceFilter = com.david.frequency.constants.ArtistSourceFilter.ALL) =
        when (sortType) {
